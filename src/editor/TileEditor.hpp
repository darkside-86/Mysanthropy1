...
namespace editor
{
    ...
    private:
        ...
        game::Entity* entityToPlace_ = nullptr;
        game::MobSpawner* mobSpawnerToPlace_ = nullptr;
        int entityID_ = 0;
        int mobSpawnerID_ = 0;
        std::vector<game::Entity*> entities_;
        std::vector<game::MobSpawner*> mobSpawners_;
        bool collisionLayerSelected_ = false;
        int cameraX_=0, cameraY_=0;
        game::Sprite* skullIcon_; // represents spawners
    };
}